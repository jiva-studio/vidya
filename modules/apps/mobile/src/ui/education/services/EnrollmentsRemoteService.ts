import type { GetEnrollmentResponse, GetEnrollmentsResponse, CreateEnrollmentRequest, UpdateEnrollmentResponse, UpdateEnrollmentRequest } from '@/legacy-protocol/EnrollmentsService'
