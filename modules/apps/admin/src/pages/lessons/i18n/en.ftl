...
lesson-version-draft = Draft v{ $draft }
lesson-version-published = Published v{ $published }
lesson-version-revising = Published v{ $published } · draft v{ $draft }
lesson-version-unknown = No content yet
