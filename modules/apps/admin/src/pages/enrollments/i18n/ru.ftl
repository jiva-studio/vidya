...
enrollments-filter-group = Группа
...
enrollments-revoke-consequence = Студент перестанет учиться на курсе и потеряет место в группе. Если передумаете — кнопка «Вернуть на курс».
enrollments-restore = Вернуть на курс
enrollments-restore-title = Вернуть студента на курс?
enrollments-restore-consequence = Студент снова сможет учиться на курсе.
