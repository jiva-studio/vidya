...
schools-column-actions = Actions
schools-empty-title = No schools yet
schools-empty-body = Create a school, then add roles and people to it.
...
schools-settings-empty-body = Create a role in this school first.
